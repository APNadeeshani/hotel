...
<ul class="breadcrumb">
  <li><a href="#">Home</a></li>
  <li><a href="#" class="brkmn" id="0" name="cusmass_home.php">Hotels</a></li>
...
<div class="panel-heading">
  ...
  <div class="pull-right">
    ...
    <a  href="{{url('/hotels/home')}}" class="btn btn-danger" id="clofm"><span class="fa fa-times">&nbsp;</span>Close</a>
  </div>
</div>
<div class="panel-body">

    <div class="row" style="padding-top:5px;">
    <h3 class="text-title">Hotels Information</h3>
    <div class="col-md-6">
      <div class="form-group">
        <label class="col-md-3 col-xs-12 control-label text-left">Hotel Name</label>
      ...
      <div class="form-group">
        <label class="col-md-3 col-xs-12 control-label text-left">Email</label>
        <div class="col-md-8 col-xs-12">
        	<input type="text" class="form-control" name="dena" id="dena" value="" autocomplete="off" />
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-3 col-xs-12 control-label text-left">Phone</label>
        <div class="col-md-8 col-xs-12">
        	<input type="text" class="form-control" name="dena" id="dena" value="" autocomplete="off" />
        </div>
      </div>
