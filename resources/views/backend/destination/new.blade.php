...
<div class="panel-heading">
  <div class="panel-title-box">
    <h3>&nbsp;DESTINATION CREATE</h3>
  </div>
  <div class="pull-right">
    <button type="submit" class="btn btn-success" id="savfm"><span class="fa fa-floppy-o">&nbsp;</span>Save</button>
    <a  href="{{url('/destination')}}" class="btn btn-danger" id="clofm"><span class="fa fa-times">&nbsp;</span>Close</a>
  </div>
</div>
<div class="panel-body">
    ...
    <div class="col-md-6">
      <div class="form-group">
        <label class="col-md-3 col-xs-12 control-label text-left">Destination Name</label>
