							...
							<div class="row " >
								...
								<div class="gallery gaps masonary " id="loard">
									...
									<div class="col-md-4 specials">
										...
										<input type="hidden" id="destinationehide" value="{{ $value->destination}}">
									</div>
...
$(document).ready(function(){
	$('.advflt').change(function(e){	
		...
		var destinationehide=$('#destinationehide').val();
		$.ajax({
		 // url: base_url + "/hotelssearchfrom",
          url: "{{url('hotelssearchfromdestination')}}",
          type:'post',
		  data: {"_token":csrf_token, "swimming":swimming, "breakfast":breakfast, "privatebathroom":privatebathroom, "beachfront":beachfront,"airconditioning":airconditioning,
			...
			"Washing":Washing,"hottub":hottub,"Soundproofing3":Soundproofing3,"electric":electric ,"coffeemachine":coffeemachine, "destinationehide":destinationehide},
          async: false,
